  ...
  const handleDragOver = (e) => {
    ...
    if (activeColumn._id !== overColumn._id) {
      setOrderedColumns(prevColumns => {
        ...
        //Biến isBelowOverItem được gán giá trị dựa trên biểu thức active.rect.current.translated.top > over.rect.top + over.rect.height. Nó kiểm tra xem vị trí trên cùng của activeCard có nằm dưới vị trí dưới cùng của overCard hay không
